...
Then add the following Liberty features: monitor-1.0 and restconnector-1.0
Once deployed RESTful GET requests can be sent using the following syntax assuming the project was deployed with the 
com.ibm.cicsdev.jmxquery web context root
...
These request will return a JSON object containing the application and state as reported by the WebSphere:service=com.ibm.websphere.application.ApplicationMBean
